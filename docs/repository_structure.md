...
├── docs/
│   ├── assets/videos/          # README demo media (odoo_setup.mp4, trmnl_display.gif)
│   ├── admin_manual.pdf
│   ├── user_guide.pdf
...
- `assets/videos/` — demo video and GIF for the README
...
Python packages installed in the Odoo container (`pillow`, `requests`). The TRMNL module manifest requires **Pillow** only.
